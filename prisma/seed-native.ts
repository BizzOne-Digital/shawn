...
async function main() {
  ...
  const plans = [
    { slug: "business-free-basic", name: "Free Basic Listing", memberType: "BUSINESS", businessTier: "FREE_BASIC", monthlyPrice: 0, yearlyPrice: 0, sortOrder: 1, maxImages: 0, maxDescriptionChars: 0, features: ["Company name", "Address", "Phone number", "Website URL"] },
    { slug: "business-pro", name: "Pro Listing", memberType: "BUSINESS", businessTier: "PRO", monthlyPrice: 4.99, yearlyPrice: 49, sortOrder: 2, maxImages: 2, maxDescriptionChars: 5000, allowsVideo: true, allowsCoupon: true, allowsSocialLinks: true, allowsSearchKeywords: true, allowsLgbEmail: true, isPreLaunchPricing: true, features: ["Logo & images", "Social media links", "Coupon & promo code", "Free @LetsGoBuffalo.com email", "Full description"] },
