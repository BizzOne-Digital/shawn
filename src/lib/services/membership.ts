...
export const DEFAULT_PLANS = [
  {
    ...
    description: "Company name, address, phone, and website URL.",
    monthlyPrice: 0,
    yearlyPrice: 0,
    sortOrder: 1,
    maxImages: 0,
  ...
  },
  {
    ...
    features: [
      ...
      "Business logo & additional images",
      "Social media links",
      "Coupon & promo code",
      "Free yourname@LetsGoBuffalo.com email",
      "Full description & search keywords",
