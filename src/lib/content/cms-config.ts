...
export type CmsImageFolder = "products" | "gallery" | "pages" | "misc";
...
function img(
  ...
  label: string,
  defaultValue: string,
  imageFolder: CmsImageFolder = "pages"
): CmsField {
  return { key, label, default: defaultValue, type: "image", imageFolder };
}
  ...
  },
  {
    ...
    sections: [
      ...
      section("products", "Products", [
        img("products.item_0.image", "Product 1 image", "", "products"),
        ...
        img("products.item_1.image", "Product 2 image", "", "products"),
        ...
        img("products.item_2.image", "Product 3 image", "", "products"),
        ...
        img("products.item_3.image", "Product 4 image", "", "products"),
