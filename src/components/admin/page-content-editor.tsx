...
export function PageContentEditor({ page, initialContent }: PageContentEditorProps) {
  ...
  const hasImageFields = page.sections.some((section) =>
      ...
      {page.sections.map((cmsSection) => (
        <Card key={cmsSection.id}>
          <CardHeader>
            ...
            <CardDescription>
              {hasImageFields
                ? "Edit text and image content for this section."
                : "Edit text content for this section."}
            </CardDescription>
          </CardHeader>
              ...
              <div key={field.key} className="space-y-2">
                {field.type === "image" ? (
                  <LocalImageField
                    ...
                    folder={field.imageFolder ?? "pages"}
                  />
                ) : (
                  <>
